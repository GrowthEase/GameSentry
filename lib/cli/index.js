...
const cocos_js = require("../cocos/cocos-js")
const cocos_lua = require("../cocos/cocos-lua")
...
rpc.exports = {
    ...
    cocos_js_dump_replace:cocos_js.dump_and_replace_js,
    cocos_lua_dump_replace:cocos_lua.cocos_lua_init,
};
                ...
                onLeave: function (retval) {
                    ...
                    if (module_xlua != null) {
                        ...
                        if (start_hotfix) {
                            ...
                            lua_dump.dump_lua(target, module_xlua,"unity_dump_lua_exist")
                        }
                    }
                }
            });
